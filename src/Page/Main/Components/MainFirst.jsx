            ...
            <div className="textBox">
                ...
                <p className="line02">
                    ...
                    >
                        ...
                        <span className={count !== 1 ? "active test" : "test"}>
                            상
                        </span>
                    </strong>
                    하고
                ...
                <p>
                    ...
                    >
                        <span className="test">문화</span>
                        <span
                            className={[0, 1].includes(count) ? "active" : ""}
                            ref={(el) => {
                                ref.current[0] = el;
                                ref.current[1] = el;
                            }}
                        ...
                        <span
                            className={[2, 3].includes(count) ? "active" : ""}
                            ref={(el) => {
                                ref.current[2] = el;
                                ref.current[3] = el;
                            }}
