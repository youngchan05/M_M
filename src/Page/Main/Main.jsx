          ...
          <p className="line02">
            ...
            >
              <span className={count === 1 ? "active" : ""}>
                <img ref={imgRef3} src="./asset/partly_cloudy_night (2).png" />
              </span>
              <span className={count !== 1 ? "active" : ""}>상</span>
            </strong>
            하고
          </p>
          <p>
          ...
          <p className="last">
            ...
            <p className="inner">
              ...
              >
                ...
                >
                  <img className="logo" src="./asset/img_logo.png" />
                </span>
                <span
                  className={[1, 2].includes(count) ? "active" : ""}
                  ref={(el) => {
                    ref2.current[1] = el;
                    ref2.current[2] = el;
                  }}
